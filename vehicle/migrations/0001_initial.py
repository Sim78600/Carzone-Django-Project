    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo1', models.ImageField(blank=True, upload_to='photos/cars/%Y/%m/%d/')),
                ('car_photo2', models.ImageField(blank=True, upload_to='photos/cars/%Y/%m/%d/')),
                ('car_photo3', models.ImageField(blank=True, upload_to='photos/cars/%Y/%m/%d/')),
                ('car_photo4', models.ImageField(blank=True, upload_to='photos/cars/%Y/%m/%d/')),
                ...
                ('created_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 10, 31, 1, 53, 38, 707882))),
            ],
        ),
    ]
